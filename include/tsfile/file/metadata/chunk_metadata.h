...
public:
     ...
     * @return
     */
    std::error_code write_to(ostream &stream);
    /**
     *
     */
    friend std::ostream &operator<<(std::ostream &os, const chunck_metadata &p);
...
std::ostream &operator<<(std::ostream &os, const chunck_metadata &p);
